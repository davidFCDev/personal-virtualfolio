    ...
    return (
        <section id='skills' className='skills'>
            <div className='skills-container'>
                <h1 className="section-ttl text-center "><b>&lt;h2&gt;&nbsp;</b>&nbsp;&nbsp;Tecnologías&nbsp;&nbsp;<b>&lt;/h2&gt;&nbsp;</b></h1>
            ...
            <div className='studies-container'>
                <h1 className="section-ttl text-center "><b>&lt;h2&gt;&nbsp;</b>&nbsp;&nbsp;Estudios&nbsp;&nbsp;<b>&lt;/h2&gt;&nbsp;</b></h1>
                <ul className='studies-list'>
                    <motion.div 
                        initial={{ opacity: 0, x: 50 }}
                        animate={inView1 ? animationOptions : {}}>
                        <li className="card" ref={ref1}>
                            <img src='/images/iconoAngular.png' alt='angular' className="img"/>
                            <div className="textBox">
                                <div className="textContent">
                                    <p className="h1">Curso Angular</p>
                                    <span className="span flex flex-row-reverse items-center">live<TbPoint className='text-xl text-green-400'/></span>
                                </div>
                                <p className="p">Estudiando actualmente!</p>
                            </div>
                        </li>
                    </motion.div>
                    <motion.div 
                        ...
                        <li className="card" ref={ref3}>
                            ...
                            <div className="textBox">
                                <div className="textContent">
                                    ...
                                    <span className="span">9 month ago</span>
                                </div>
                    ...
                    <motion.div 
                        ...
                        <li id="css" className="card" ref={ref4}>
                            <img
                                ref={imgRef}
                                src={isHtmlImage ? "/images/iconoHtml.png" : "/images/iconoCss.png"} 
                                alt='html' 
                                className="img"/>
                            <div className="textBox">
                                <div className="textContent">
